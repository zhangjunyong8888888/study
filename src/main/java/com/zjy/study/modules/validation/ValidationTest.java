package com.zjy.study.modules.validation;
...
//        userInfo.setUserId("zhangjunyong");
        //userInfo.setUserName("张俊勇");
        userInfo.setPassWord("zhangjunyong");
//        userInfo.setEmail("zhangjunyong@sina.cn");
        userInfo.setAge(30);
...
//        friend.setUserId("wangjunyong");
        friend.setUserName("王俊勇");
        friend.setPassWord("wangjunyong");
//        friend.setEmail("wangjunyong@sina.cn");
    ...
    public void groupValidation() {
        set = validator.validate(userInfo,
                ...
                UserInfo.LoginGroup.class, Default.class);
    }
